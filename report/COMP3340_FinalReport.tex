...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=3in]{images/q1.png}
	\caption{languages example  screenshot (from index.php)}
 \end{figure}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=3in]{images/q2-a.png}
	\caption{Plotly JS Graphing Library and Google Map API example screenshot (from index.php)}
 \end{figure}

 \begin{figure}[htbp]
	\centering
	\includegraphics[width=3in]{images/q2-b.png}
	\caption{Apple MapKit JS example screenshot (from city.php)}
 \end{figure}

 \begin{figure}[htbp]
	\centering
	\includegraphics[width=3in]{images/q2-c.png}
	\caption{Bootstrap example screenshot (from bootstrap.css)}
 \end{figure}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=3in]{images/q3.png}
	\caption{Map and images example Screenshot}
 \end{figure}
...
1 main menu [Home Page, Find Dream City, My Favourites, Server Status, 		  	Documentation, About, Log out]

\begin{figure}[htbp]
	\centering
	\includegraphics[width=3in]{images/q4-a.png}
	\caption{Menu Screenshot}
 \end{figure}

 \begin{figure}[htbp]
	\centering
	\includegraphics[width=3in]{images/q4-b.png}
	\caption{Menu Code example screenshot (from navigation.php)}
 \end{figure}
...
Able to create new users, edit user information, login, logout, user change  username/password

 \begin{figure}[htbp]
	\centering
	\includegraphics[width=3in]{images/q5-a.png}
	\caption{login/register example screenshot}
 \end{figure}

 \begin{figure}[htbp]
	\centering
	\includegraphics[width=3in]{images/q5-b.png}
	\caption{Logout example screenshot}
 \end{figure}

 \begin{figure}[htbp]
	\centering
	\includegraphics[width=3in]{images/q5-c.png}
	\caption{user change username/password example screenshot}
 \end{figure}

 \begin{figure}[htbp]
	\centering
	\includegraphics[width=3in]{images/q5-d.png}
	\caption{Login code example screenshot (from login.php)}
 \end{figure}

 \begin{figure}[htbp]
	\centering
	\includegraphics[width=3in]{images/q5-e.png}
	\caption{Logout example screenshot (from logout.php)}
 \end{figure}

 \begin{figure}[htbp]
	\centering
	\includegraphics[width=3in]{images/q5-f.png}
	\caption{User change username/password example screenshot (from user change.php)}
 \end{figure}

 \begin{figure}[htbp]
	\centering
	\includegraphics[width=3in]{images/q5-g.png}
	\caption{Edit user example screenshot (from edit user.php)}
 \end{figure}
